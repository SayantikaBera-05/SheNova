    ...
    <div className="space-y-4" id="music">
      <div className="flex flex-col gap-1 sm:gap-1.5">
        <h3 className="text-xl sm:text-2xl font-extrabold text-foreground flex items-center gap-2 transition-colors duration-500">
          ...
          <Music className="w-4 h-4 sm:w-5 sm:h-5 text-[#1DB954] shrink-0" />
        </h3>
        {analysisResult.playlistDescription && (
          <p className="text-[11px] sm:text-xs text-muted-foreground leading-relaxed flex items-center gap-1.5 transition-colors duration-500 font-medium">
            <Radio className="w-3.5 h-3.5 text-purple-600 dark:text-neonCyan shrink-0" />
