    ...
    >
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        <div className="flex items-center gap-2.5">
          <div className="w-8 h-8 rounded-xl bg-gradient-to-tr from-purple-600 via-pink-500 to-cyan-400 flex items-center justify-center shadow-md">
            <Sparkles className="w-4 h-4 text-white animate-pulse" />
          </div>
          <span className="text-xl font-extrabold tracking-tight text-foreground hidden sm:block transition-colors duration-500">
        ...
        <div className="flex items-center gap-3">
          ...
          <Button
            ...
            className="rounded-full border-purple-200/60 dark:border-white/20 bg-white/70 dark:bg-white/10 hover:bg-purple-100 dark:hover:bg-white/20 text-foreground transition-all duration-300 gap-1.5 px-3 h-9"
          >
          ...
          <Button 
            className="hidden sm:inline-flex rounded-full px-5 h-9 bg-purple-950 text-white hover:bg-purple-900 dark:bg-white dark:text-black dark:hover:bg-gray-200 font-medium text-xs shadow-md transition-all duration-300 hover:scale-105" 
            onClick={() => {
          ...
          <Sheet>
            ...
            <SheetContent side="right" className="bg-popover border-purple-200/40 dark:border-white/10">
